...
def create_sunshine_comparison_plot(data):
    
    """
    
    Create a line plot comparing sunshine duration for multiple years.
    Parameters:
        data (dict): A dictionary where keys are years and values are lists of sunshine data.
